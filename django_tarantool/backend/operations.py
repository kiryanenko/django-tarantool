...
class DatabaseOperations(BaseDatabaseOperations):
    ...
    def convert_booleanfield_value(self, value, expression, connection, *args, **kwargs):
        return value
    ...
    def convert_timefield_value(self, value, expression, connection, *args, **kwargs):
        if value is None:
            return None
    ...
    def convert_uuidfield_value(self, value, expression, connection, *args, **kwargs):
